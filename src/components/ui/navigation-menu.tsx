...
const NavigationMenuMarker = React.forwardRef<
  React.ElementRef<typeof NavigationMenuPrimitive.Marker>,
  React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitive.Marker>
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Marker
    ref={ref}
    className={cn(
...
NavigationMenuMarker.displayName = NavigationMenuPrimitive.Marker.displayName
